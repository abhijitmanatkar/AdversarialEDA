"""Behavioural cloning on trajectories without back actions."""
...
with open('./expert_trajectories_no_back/train/1.pkl', 'rb') as f:
...
bc_trainer.save_policy('./bc_policy_no_back')
