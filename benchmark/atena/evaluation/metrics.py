...
from benchmark.atena.evaluation.utils import (
    precision_score_without_back,
    compute_minimum_display_TED_from_actions, tree_corpus_bleu_n,
)
from benchmark.atena.simulation.actions import AbstractAction, ActionType
from benchmark.atena.simulation.actions_simulator import ActionsSimulator
...
from benchmark.atena.evaluation.references.cyber.dataset1 import cyber1_references
from benchmark.atena.evaluation.references.cyber.dataset2 import cyber2_references
from benchmark.atena.evaluation.references.cyber.dataset3 import cyber3_references
from benchmark.atena.evaluation.references.cyber.dataset4 import cyber4_references
from benchmark.atena.evaluation.references.flights.dataset1 import flights1_references
from benchmark.atena.evaluation.references.flights.dataset2 import flights2_references
from benchmark.atena.evaluation.references.flights.dataset3 import flights3_references
from benchmark.atena.evaluation.references.flights.dataset4 import flights4_references
